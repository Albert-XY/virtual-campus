...
import { Moon, Star, Clock, TrendingUp, Loader2, LogOut } from 'lucide-react'
...
function getDormitorySubtitle(): string {
  const hour = new Date().getHours()
  if (hour < 22) return '还不困？再学一会儿吧'
  if (hour < 23) return '该准备休息了'
  return '夜深了，早点休息吧'
}
